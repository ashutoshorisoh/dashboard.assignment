...
function Background() {
  return (
    <div className='lg:w-[84vw] md:w-[776px]  md:bg-red   md:fixed md:left-0 md:top-0 w-[400px] h-full ml-[215px] ipadair:ml-[161px]'>
      <div className='lg:ml-20 md:ml-10 sm:ml-2 mt-5 '>
        <div className=' flex justify-between lg:w-full w-[630px] surpro:w-[780px] p-4 rounded-lg shadow  '>
        ...
        <div className='flex lg:flex-row ipadpro:flex-col flex-col mt-[-18px]'>
          ...
          <div className='flex flex-col ml-1 mt-5 p-5 '>
            <div className='lg:w-[427px] w-[600px] ipadpro:w-[720px] surpro:w-[760px] h-[288px] lg:mt-[-20px] flex flex-col gap-2'>
